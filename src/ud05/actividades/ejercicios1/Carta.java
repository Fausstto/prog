...
public class Carta {
    ...
    public void setNumero() {
        ...
        System.out.println("Ingresa un número de carta: ");
        // falta validar que esté entre 1 y 13
        numero = sc.nextInt();
    ...
    public void setPalo() {
        Scanner sc = new Scanner(System.in);
        System.out.println("Ingresa un palo de carta: ");
        // falta validar que sea c(corazón), p (pikas), r (rombo), t(trébol)
